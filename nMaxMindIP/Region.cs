...
public class Region
{
    ...
    public Region(string countryCode, string countryName, string region, string regionCode)
    {
    ...
    public static List<MetroCode> GetMetroCodes(string regionCode)
    {
        if(!MetroCodes.ContainsKey(regionCode))
            return null;

        return MetroCodes[regionCode] as List<MetroCode>;
    }


    public static Dictionary<string, List<MetroCode>> MetroCodes { get; set; }

    public static void InitMetroCodes()
    {
        MetroCodes = new Dictionary<string, List<MetroCode>>();

        var mc_AK = new List<MetroCode>();
        mc_AK.Add(new MetroCode("Anchorage AK", 743));
        mc_AK.Add(new MetroCode("Fairbanks AK", 745));
        mc_AK.Add(new MetroCode("Juneau AK", 747));
        MetroCodes.Add("AK", mc_AK);

        var mc_AL = new List<MetroCode>();
        mc_AL.Add(new MetroCode("Birmingham AL", 630));
        mc_AL.Add(new MetroCode("Dothan AL", 606));
        mc_AL.Add(new MetroCode("Huntsville-Decatur (Florence) AL", 691));
        mc_AL.Add(new MetroCode("Mobile AL-Pensacola (Ft. Walton Beach) FL", 686));
        mc_AL.Add(new MetroCode("Montgomery (Selma) AL", 698));
        MetroCodes.Add("AL", mc_AL);

        var mc_AR = new List<MetroCode>();
        mc_AR.Add(new MetroCode("Ft. Smith-Fayetteville-Springdale-Rogers AR", 670));
        mc_AR.Add(new MetroCode("Jonesboro AR", 734));
        mc_AR.Add(new MetroCode("Little Rock-Pine Bluff AR", 693));
        mc_AR.Add(new MetroCode("Monroe LA-El Dorado AR", 628));
        MetroCodes.Add("AR", mc_AR);

        var mc_AZ = new List<MetroCode>();
        mc_AZ.Add(new MetroCode("Phoenix AZ", 753));
        mc_AZ.Add(new MetroCode("Tucson (Sierra Vista) AZ", 789));
        mc_AZ.Add(new MetroCode("Yuma AZ-El Centro CA", 771));
        MetroCodes.Add("AZ", mc_AZ);

        var mc_CA = new List<MetroCode>();
        mc_CA.Add(new MetroCode("Bakersfield CA", 800));
        mc_CA.Add(new MetroCode("Chico-Redding CA", 868));
        mc_CA.Add(new MetroCode("Eureka CA", 802));
        mc_CA.Add(new MetroCode("Fresno-Visalia CA", 866));
        mc_CA.Add(new MetroCode("Los Angeles CA", 803));
        mc_CA.Add(new MetroCode("Monterey-Salinas CA", 828));
        mc_CA.Add(new MetroCode("Palm Springs CA", 804));
        mc_CA.Add(new MetroCode("Sacramento-Stockton-Modesto CA", 862));
        mc_CA.Add(new MetroCode("San Diego CA", 825));
        mc_CA.Add(new MetroCode("San Francisco-Oakland-San Jose CA", 807));
        mc_CA.Add(new MetroCode("Santa Barbara-Santa Maria-San Luis Obispo CA", 855));
        mc_CA.Add(new MetroCode("Yuma AZ-El Centro CA", 771));
        MetroCodes.Add("CA", mc_CA);

        var mc_CO = new List<MetroCode>();
        mc_CO.Add(new MetroCode("Colorado Springs-Pueblo CO", 752));
        mc_CO.Add(new MetroCode("Denver CO", 751));
        mc_CO.Add(new MetroCode("Grand Junction-Montrose CO", 773));
        MetroCodes.Add("CO", mc_CO);

        var mc_CT = new List<MetroCode>();
        mc_CT.Add(new MetroCode("Hartford & New Haven CT", 533));
        MetroCodes.Add("CT", mc_CT);

        var mc_DC = new List<MetroCode>();
        mc_DC.Add(new MetroCode("Washington DC (Hagerstown MD)", 511));
        MetroCodes.Add("DC", mc_DC);

        var mc_FL = new List<MetroCode>();
        mc_FL.Add(new MetroCode("Ft. Myers-Naples FL", 571));
        mc_FL.Add(new MetroCode("Gainesville FL", 592));
        mc_FL.Add(new MetroCode("Jacksonville FL", 561));
        mc_FL.Add(new MetroCode("Miami-Ft. Lauderdale FL", 528));
        mc_FL.Add(new MetroCode("Mobile AL-Pensacola (Ft. Walton Beach) FL", 686));
        mc_FL.Add(new MetroCode("Orlando-Daytona Beach-Melbourne FL", 534));
        mc_FL.Add(new MetroCode("Panama City FL", 656));
        mc_FL.Add(new MetroCode("Tallahassee FL-Thomasville GA", 530));
        mc_FL.Add(new MetroCode("Tampa-St. Petersburg (Sarasota) FL", 539));
        mc_FL.Add(new MetroCode("West Palm Beach-Ft. Pierce FL", 548));
        MetroCodes.Add("FL", mc_FL);

        var mc_GA = new List<MetroCode>();
        mc_GA.Add(new MetroCode("Albany GA", 525));
        mc_GA.Add(new MetroCode("Atlanta GA", 524));
        mc_GA.Add(new MetroCode("Augusta GA", 520));
        mc_GA.Add(new MetroCode("Columbus GA", 522));
        mc_GA.Add(new MetroCode("Macon GA", 503));
        mc_GA.Add(new MetroCode("Savannah GA", 507));
        mc_GA.Add(new MetroCode("Tallahassee FL-Thomasville GA", 530));
        MetroCodes.Add("GA", mc_GA);

        var mc_HI = new List<MetroCode>();
        mc_HI.Add(new MetroCode("Honolulu HI", 744));
        MetroCodes.Add("HI", mc_HI);

        var mc_IA = new List<MetroCode>();
        mc_IA.Add(new MetroCode("Cedar Rapids-Waterloo-Iowa City & Dubuque IA", 637));
        mc_IA.Add(new MetroCode("Davenport IA-Rock Island-Moline IL", 682));
        mc_IA.Add(new MetroCode("Des Moines-Ames IA", 679));
        mc_IA.Add(new MetroCode("Ottumwa IA-Kirksville MO", 631));
        mc_IA.Add(new MetroCode("Quincy IL-Hannibal MO-Keokuk IA", 717));
        mc_IA.Add(new MetroCode("Rochester MN-Mason City IA-Austin MN", 611));
        mc_IA.Add(new MetroCode("Sioux City IA", 624));
        MetroCodes.Add("IA", mc_IA);

        var mc_ID = new List<MetroCode>();
        mc_ID.Add(new MetroCode("Boise ID", 757));
        mc_ID.Add(new MetroCode("Idaho Falls-Pocatello ID", 758));
        mc_ID.Add(new MetroCode("Twin Falls ID", 760));
        MetroCodes.Add("ID", mc_ID);

        var mc_IL = new List<MetroCode>();
        mc_IL.Add(new MetroCode("Champaign & Springfield-Decatur,IL", 648));
        mc_IL.Add(new MetroCode("Chicago IL", 602));
        mc_IL.Add(new MetroCode("Davenport IA-Rock Island-Moline IL", 682));
        mc_IL.Add(new MetroCode("Paducah KY-Cape Girardeau MO-Harrisburg-Mount Vernon IL", 632));
        mc_IL.Add(new MetroCode("Peoria-Bloomington IL", 675));
        mc_IL.Add(new MetroCode("Quincy IL-Hannibal MO-Keokuk IA", 717));
        mc_IL.Add(new MetroCode("Rockford IL", 610));
        MetroCodes.Add("IL", mc_IL);

        var mc_IN = new List<MetroCode>();
        mc_IN.Add(new MetroCode("Evansville IN", 649));
        mc_IN.Add(new MetroCode("Ft. Wayne IN", 509));
        mc_IN.Add(new MetroCode("Indianapolis IN", 527));
        mc_IN.Add(new MetroCode("Lafayette IN", 582));
        mc_IN.Add(new MetroCode("South Bend-Elkhart IN", 588));
        mc_IN.Add(new MetroCode("Terre Haute IN", 581));
        MetroCodes.Add("IN", mc_IN);

        var mc_KS = new List<MetroCode>();
        mc_KS.Add(new MetroCode("Joplin MO-Pittsburg KS", 603));
        mc_KS.Add(new MetroCode("Topeka KS", 605));
        mc_KS.Add(new MetroCode("Wichita-Hutchinson KS", 678));
        MetroCodes.Add("KS", mc_KS);

        var mc_KY = new List<MetroCode>();
        mc_KY.Add(new MetroCode("Bowling Green KY", 736));
        mc_KY.Add(new MetroCode("Lexington KY", 541));
        mc_KY.Add(new MetroCode("Louisville KY", 529));
        mc_KY.Add(new MetroCode("Paducah KY-Cape Girardeau MO-Harrisburg-Mount Vernon IL", 632));
        MetroCodes.Add("KY", mc_KY);

        var mc_LA = new List<MetroCode>();
        mc_LA.Add(new MetroCode("Alexandria LA", 644));
        mc_LA.Add(new MetroCode("Baton Rouge LA", 716));
        mc_LA.Add(new MetroCode("Lafayette LA", 642));
        mc_LA.Add(new MetroCode("Lake Charles LA", 643));
        mc_LA.Add(new MetroCode("Monroe LA-El Dorado AR", 628));
        mc_LA.Add(new MetroCode("New Orleans LA", 622));
        mc_LA.Add(new MetroCode("Shreveport LA", 612));
        MetroCodes.Add("LA", mc_LA);

        var mc_MA = new List<MetroCode>();
        mc_MA.Add(new MetroCode("Boston MA-Manchester NH", 506));
        mc_MA.Add(new MetroCode("Providence RI-New Bedford MA", 521));
        mc_MA.Add(new MetroCode("Springfield-Holyoke MA", 543));
        MetroCodes.Add("MA", mc_MA);

        var mc_MD = new List<MetroCode>();
        mc_MD.Add(new MetroCode("Baltimore MD", 512));
        mc_MD.Add(new MetroCode("Salisbury MD", 576));
        mc_MD.Add(new MetroCode("Washington DC (Hagerstown MD)", 511));
        MetroCodes.Add("MD", mc_MD);

        var mc_ME = new List<MetroCode>();
        mc_ME.Add(new MetroCode("Bangor ME", 537));
        mc_ME.Add(new MetroCode("Portland-Auburn ME", 500));
        mc_ME.Add(new MetroCode("Presque Isle ME", 552));
        MetroCodes.Add("ME", mc_ME);

        var mc_MI = new List<MetroCode>();
        mc_MI.Add(new MetroCode("Alpena MI", 583));
        mc_MI.Add(new MetroCode("Detroit MI", 505));
        mc_MI.Add(new MetroCode("Flint-Saginaw-Bay City MI", 513));
        mc_MI.Add(new MetroCode("Grand Rapids-Kalamazoo-Battle Creek MI", 563));
        mc_MI.Add(new MetroCode("Lansing MI", 551));
        mc_MI.Add(new MetroCode("Marquette MI", 553));
        mc_MI.Add(new MetroCode("Traverse City-Cadillac MI", 540));
        MetroCodes.Add("MI", mc_MI);

        var mc_MN = new List<MetroCode>();
        mc_MN.Add(new MetroCode("Duluth MN-Superior WI", 676));
        mc_MN.Add(new MetroCode("Mankato MN", 737));
        mc_MN.Add(new MetroCode("Minneapolis-St. Paul MN", 613));
        mc_MN.Add(new MetroCode("Rochester MN-Mason City IA-Austin MN", 611));
        MetroCodes.Add("MN", mc_MN);

        var mc_MO = new List<MetroCode>();
        mc_MO.Add(new MetroCode("Columbia-Jefferson City MO", 604));
        mc_MO.Add(new MetroCode("Joplin MO-Pittsburg KS", 603));
        mc_MO.Add(new MetroCode("Kansas City MO", 616));
        mc_MO.Add(new MetroCode("Ottumwa IA-Kirksville MO", 631));
        mc_MO.Add(new MetroCode("Paducah KY-Cape Girardeau MO-Harrisburg-Mount Vernon IL", 632));
        mc_MO.Add(new MetroCode("Quincy IL-Hannibal MO-Keokuk IA", 717));
        mc_MO.Add(new MetroCode("Springfield MO", 619));
        mc_MO.Add(new MetroCode("St. Joseph MO", 638));
        mc_MO.Add(new MetroCode("St. Louis MO", 609));
        MetroCodes.Add("MO", mc_MO);

        var mc_MS = new List<MetroCode>();
        mc_MS.Add(new MetroCode("Biloxi-Gulfport MS", 746));
        mc_MS.Add(new MetroCode("Columbus-Tupelo-West Point MS", 673));
        mc_MS.Add(new MetroCode("Greenwood-Greenville MS", 647));
        mc_MS.Add(new MetroCode("Hattiesburg-Laurel MS", 710));
        mc_MS.Add(new MetroCode("Jackson MS", 718));
        mc_MS.Add(new MetroCode("Meridian MS", 711));
        MetroCodes.Add("MS", mc_MS);

        var mc_MT = new List<MetroCode>();
        mc_MT.Add(new MetroCode("Billings MT", 756));
        mc_MT.Add(new MetroCode("Butte-Bozeman MT", 754));
        mc_MT.Add(new MetroCode("Glendive MT", 798));
        mc_MT.Add(new MetroCode("Great Falls MT", 755));
        mc_MT.Add(new MetroCode("Helena MT", 766));
        mc_MT.Add(new MetroCode("Missoula MT", 762));
        MetroCodes.Add("MT", mc_MT);

        var mc_NC = new List<MetroCode>();
        mc_NC.Add(new MetroCode("Charlotte NC", 517));
        mc_NC.Add(new MetroCode("Greensboro-High Point-Winston Salem NC", 518));
        mc_NC.Add(new MetroCode("Greenville-New Bern-Washington NC", 545));
        mc_NC.Add(new MetroCode("Greenville-Spartanburg SC-Asheville NC-Anderson SC", 567));
        mc_NC.Add(new MetroCode("Raleigh-Durham (Fayetteville) NC", 560));
        mc_NC.Add(new MetroCode("Wilmington NC", 550));
        MetroCodes.Add("NC", mc_NC);

        var mc_ND = new List<MetroCode>();
        mc_ND.Add(new MetroCode("Fargo-Valley City ND", 724));
        mc_ND.Add(new MetroCode("Minot-Bismarck-Dickinson(Williston) ND", 687));
        MetroCodes.Add("ND", mc_ND);

        var mc_NE = new List<MetroCode>();
        mc_NE.Add(new MetroCode("Cheyenne WY-Scottsbluff NE", 759));
        mc_NE.Add(new MetroCode("Lincoln & Hastings-Kearney NE", 722));
        mc_NE.Add(new MetroCode("North Platte NE", 740));
        mc_NE.Add(new MetroCode("Omaha NE", 652));
        MetroCodes.Add("NE", mc_NE);

        var mc_NH = new List<MetroCode>();
        mc_NH.Add(new MetroCode("Boston MA-Manchester NH", 506));
        MetroCodes.Add("NH", mc_NH);

        var mc_NM = new List<MetroCode>();
        mc_NM.Add(new MetroCode("Albuquerque-Santa Fe NM", 790));
        MetroCodes.Add("NM", mc_NM);

        var mc_NV = new List<MetroCode>();
        mc_NV.Add(new MetroCode("Las Vegas NV", 839));
        mc_NV.Add(new MetroCode("Reno NV", 811));
        MetroCodes.Add("NV", mc_NV);

        var mc_NY = new List<MetroCode>();
        mc_NY.Add(new MetroCode("Albany-Schenectady-Troy NY", 532));
        mc_NY.Add(new MetroCode("Binghamton NY", 502));
        mc_NY.Add(new MetroCode("Buffalo NY", 514));
        mc_NY.Add(new MetroCode("Burlington VT-Plattsburgh NY", 523));
        mc_NY.Add(new MetroCode("Elmira NY", 565));
        mc_NY.Add(new MetroCode("New York NY", 501));
        mc_NY.Add(new MetroCode("Rochester NY", 538));
        mc_NY.Add(new MetroCode("Syracuse NY", 555));
        mc_NY.Add(new MetroCode("Utica NY", 526));
        mc_NY.Add(new MetroCode("Watertown NY", 549));
        MetroCodes.Add("NY", mc_NY);

        var mc_OH = new List<MetroCode>();
        mc_OH.Add(new MetroCode("Cincinnati OH", 515));
        mc_OH.Add(new MetroCode("Cleveland-Akron (Canton) OH", 510));
        mc_OH.Add(new MetroCode("Columbus OH", 535));
        mc_OH.Add(new MetroCode("Dayton OH", 542));
        mc_OH.Add(new MetroCode("Lima OH", 558));
        mc_OH.Add(new MetroCode("Toledo OH", 547));
        mc_OH.Add(new MetroCode("Wheeling WV-Steubenville OH", 554));
        mc_OH.Add(new MetroCode("Youngstown OH", 536));
        mc_OH.Add(new MetroCode("Zanesville OH", 596));
        MetroCodes.Add("OH", mc_OH);

        var mc_OK = new List<MetroCode>();
        mc_OK.Add(new MetroCode("Oklahoma City OK", 650));
        mc_OK.Add(new MetroCode("Sherman TX-Ada OK", 657));
        mc_OK.Add(new MetroCode("Tulsa OK", 671));
        mc_OK.Add(new MetroCode("Wichita Falls TX & Lawton OK", 627));
        MetroCodes.Add("OK", mc_OK);

        var mc_OR = new List<MetroCode>();
        mc_OR.Add(new MetroCode("Bend OR", 821));
        mc_OR.Add(new MetroCode("Eugene OR", 801));
        mc_OR.Add(new MetroCode("Medford-Klamath Falls OR", 813));
        mc_OR.Add(new MetroCode("Portland OR", 820));
        MetroCodes.Add("OR", mc_OR);

        var mc_PA = new List<MetroCode>();
        mc_PA.Add(new MetroCode("Erie PA", 516));
        mc_PA.Add(new MetroCode("Harrisburg-Lancaster-Lebanon-York PA", 566));
        mc_PA.Add(new MetroCode("Johnstown-Altoona PA", 574));
        mc_PA.Add(new MetroCode("Philadelphia PA", 504));
        mc_PA.Add(new MetroCode("Pittsburgh PA", 508));
        mc_PA.Add(new MetroCode("Wilkes Barre-Scranton PA", 577));
        MetroCodes.Add("PA", mc_PA);

        var mc_RI = new List<MetroCode>();
        mc_RI.Add(new MetroCode("Providence RI-New Bedford MA", 521));
        MetroCodes.Add("RI", mc_RI);

        var mc_SC = new List<MetroCode>();
        mc_SC.Add(new MetroCode("Charleston SC", 519));
        mc_SC.Add(new MetroCode("Columbia SC", 546));
        mc_SC.Add(new MetroCode("Florence-Myrtle Beach SC", 570));
        mc_SC.Add(new MetroCode("Greenville-Spartanburg SC-Asheville NC-Anderson SC", 567));
        MetroCodes.Add("SC", mc_SC);

        var mc_SD = new List<MetroCode>();
        mc_SD.Add(new MetroCode("Rapid City SD", 764));
        mc_SD.Add(new MetroCode("Sioux Falls(Mitchell) SD", 725));
        MetroCodes.Add("SD", mc_SD);

        var mc_TN = new List<MetroCode>();
        mc_TN.Add(new MetroCode("Chattanooga TN", 575));
        mc_TN.Add(new MetroCode("Jackson TN", 639));
        mc_TN.Add(new MetroCode("Knoxville TN", 557));
        mc_TN.Add(new MetroCode("Memphis TN", 640));
        mc_TN.Add(new MetroCode("Nashville TN", 659));
        mc_TN.Add(new MetroCode("Tri-Cities TN-VA", 531));
        MetroCodes.Add("TN", mc_TN);

        var mc_TX = new List<MetroCode>();
        mc_TX.Add(new MetroCode("Abilene-Sweetwater TX", 662));
        mc_TX.Add(new MetroCode("Amarillo TX", 634));
        mc_TX.Add(new MetroCode("Austin TX", 635));
        mc_TX.Add(new MetroCode("Beaumont-Port Arthur TX", 692));
        mc_TX.Add(new MetroCode("Corpus Christi TX", 600));
        mc_TX.Add(new MetroCode("Dallas-Ft. Worth TX", 623));
        mc_TX.Add(new MetroCode("El Paso TX", 765));
        mc_TX.Add(new MetroCode("Harlingen-Weslaco-Brownsville-McAllen TX", 636));
        mc_TX.Add(new MetroCode("Houston TX", 618));
        mc_TX.Add(new MetroCode("Laredo TX", 749));
        mc_TX.Add(new MetroCode("Lubbock TX", 651));
        mc_TX.Add(new MetroCode("Odessa-Midland TX", 633));
        mc_TX.Add(new MetroCode("San Angelo TX", 661));
        mc_TX.Add(new MetroCode("San Antonio TX", 641));
        mc_TX.Add(new MetroCode("Sherman TX-Ada OK", 657));
        mc_TX.Add(new MetroCode("Tyler-Longview(Lufkin & Nacogdoches) TX", 709));
        mc_TX.Add(new MetroCode("Victoria TX", 626));
        mc_TX.Add(new MetroCode("Waco-Temple-Bryan TX", 625));
        mc_TX.Add(new MetroCode("Wichita Falls TX & Lawton OK", 627));
        MetroCodes.Add("TX", mc_TX);

        var mc_UT = new List<MetroCode>();
        mc_UT.Add(new MetroCode("Salt Lake City UT", 770));
        MetroCodes.Add("UT", mc_UT);

        var mc_VA = new List<MetroCode>();
        mc_VA.Add(new MetroCode("Charlottesville VA", 584));
        mc_VA.Add(new MetroCode("Harrisonburg VA", 569));
        mc_VA.Add(new MetroCode("Norfolk-Portsmouth-Newport News VA", 544));
        mc_VA.Add(new MetroCode("Richmond-Petersburg VA", 556));
        mc_VA.Add(new MetroCode("Roanoke-Lynchburg VA", 573));
        mc_VA.Add(new MetroCode("Tri-Cities TN-VA", 531));
        MetroCodes.Add("VA", mc_VA);

        var mc_VT = new List<MetroCode>();
        mc_VT.Add(new MetroCode("Burlington VT-Plattsburgh NY", 523));
        MetroCodes.Add("VT", mc_VT);

        var mc_WA = new List<MetroCode>();
        mc_WA.Add(new MetroCode("Seattle-Tacoma WA", 819));
        mc_WA.Add(new MetroCode("Spokane WA", 881));
        mc_WA.Add(new MetroCode("Yakima-Pasco-Richland-Kennewick WA", 810));
        MetroCodes.Add("WA", mc_WA);

        var mc_WI = new List<MetroCode>();
        mc_WI.Add(new MetroCode("Duluth MN-Superior WI", 676));
        mc_WI.Add(new MetroCode("Green Bay-Appleton WI", 658));
        mc_WI.Add(new MetroCode("La Crosse-Eau Claire WI", 702));
        mc_WI.Add(new MetroCode("Madison WI", 669));
        mc_WI.Add(new MetroCode("Milwaukee WI", 617));
        mc_WI.Add(new MetroCode("Wausau-Rhinelander WI", 705));
        MetroCodes.Add("WI", mc_WI);

        var mc_WV = new List<MetroCode>();
        mc_WV.Add(new MetroCode("Bluefield-Beckley-Oak Hill WV", 559));
        mc_WV.Add(new MetroCode("Charleston-Huntington WV", 564));
        mc_WV.Add(new MetroCode("Clarksburg-Weston WV", 598));
        mc_WV.Add(new MetroCode("Parkersburg WV", 597));
        mc_WV.Add(new MetroCode("Wheeling WV-Steubenville OH", 554));
        MetroCodes.Add("WV", mc_WV);

        var mc_WY = new List<MetroCode>();
        mc_WY.Add(new MetroCode("Casper-Riverton WY", 767));
        mc_WY.Add(new MetroCode("Cheyenne WY-Scottsbluff NE", 759));
        MetroCodes.Add("WY", mc_WY);
    }

    public static Hashtable GEOIP_REGION_NAME { get; set; }
	...
	public static String GetRegionName (String ccode, String region)
	{
        ...
        if (!((SortedDictionary<string, string>)GEOIP_REGION_NAME[ccode]).ContainsKey(region))
        {
            return null;
        }
		
		return (string)((SortedDictionary<string, string>)GEOIP_REGION_NAME[ccode])[region];
	}
	...
	private static void init_region_names ()
	{
		...
		var cc_reg_AD = new SortedDictionary<string,string>();
		...
		var cc_reg_AE = new SortedDictionary<string,string>();
		...
		var cc_reg_AF = new SortedDictionary<string,string>();
		...
		var cc_reg_AG = new SortedDictionary<string,string>();
		...
		var cc_reg_AL = new SortedDictionary<string,string>();
		...
		var cc_reg_AM = new SortedDictionary<string,string>();
		...
		var cc_reg_AO = new SortedDictionary<string,string>();
		...
		var cc_reg_AR = new SortedDictionary<string,string>();
		...
		var cc_reg_AT = new SortedDictionary<string,string>();
		...
		var cc_reg_AU = new SortedDictionary<string,string>();
		...
		var cc_reg_AZ = new SortedDictionary<string,string>();
		...
		var cc_reg_BD = new SortedDictionary<string,string>();
		...
		var cc_reg_BE = new SortedDictionary<string,string>();
		...
		var cc_reg_BF = new SortedDictionary<string,string>();
		...
		var cc_reg_BG = new SortedDictionary<string,string>();
		...
		var cc_reg_BH = new SortedDictionary<string,string>();
		...
		var cc_reg_BI = new SortedDictionary<string,string>();
		...
		var cc_reg_BJ = new SortedDictionary<string,string>();
		...
		var cc_reg_BM = new SortedDictionary<string,string>();
		...
		var cc_reg_BN = new SortedDictionary<string,string>();
		...
		var cc_reg_BO = new SortedDictionary<string,string>();
		...
		var cc_reg_BR = new SortedDictionary<string,string>();
		...
		var cc_reg_BS = new SortedDictionary<string,string>();
		...
		var cc_reg_BT = new SortedDictionary<string,string>();
		...
		var cc_reg_BW = new SortedDictionary<string,string>();
		...
		var cc_reg_BY = new SortedDictionary<string,string>();
		...
		var cc_reg_BZ = new SortedDictionary<string,string>();
		...
		var cc_reg_CA = new SortedDictionary<string,string>();
		...
		var cc_reg_CD = new SortedDictionary<string,string>();
		...
		var cc_reg_CF = new SortedDictionary<string,string>();
		...
		var cc_reg_CG = new SortedDictionary<string,string>();
		...
		var cc_reg_CH = new SortedDictionary<string,string>();
		...
		var cc_reg_CI = new SortedDictionary<string,string>();
		...
		var cc_reg_CL = new SortedDictionary<string,string>();
		...
		var cc_reg_CM = new SortedDictionary<string,string>();
		...
		var cc_reg_CN = new SortedDictionary<string,string>();
		...
		var cc_reg_CO = new SortedDictionary<string,string>();
		...
		var cc_reg_CR = new SortedDictionary<string,string>();
		...
		var cc_reg_CU = new SortedDictionary<string,string>();
		...
		var cc_reg_CV = new SortedDictionary<string,string>();
		...
		var cc_reg_CY = new SortedDictionary<string,string>();
		...
		var cc_reg_CZ = new SortedDictionary<string,string>();
		...
		var cc_reg_DE = new SortedDictionary<string,string>();
		...
		var cc_reg_DJ = new SortedDictionary<string,string>();
		...
		var cc_reg_DK = new SortedDictionary<string,string>();
		...
		var cc_reg_DM = new SortedDictionary<string,string>();
		...
		var cc_reg_DO = new SortedDictionary<string,string>();
		...
		var cc_reg_DZ = new SortedDictionary<string,string>();
		...
		var cc_reg_EC = new SortedDictionary<string,string>();
		...
		var cc_reg_EE = new SortedDictionary<string,string>();
		...
		var cc_reg_EG = new SortedDictionary<string,string>();
		...
		var cc_reg_ER = new SortedDictionary<string,string>();
		...
		var cc_reg_ES = new SortedDictionary<string,string>();
		...
		var cc_reg_ET = new SortedDictionary<string,string>();
		...
		var cc_reg_FI = new SortedDictionary<string,string>();
		...
		var cc_reg_FJ = new SortedDictionary<string,string>();
		...
		var cc_reg_FM = new SortedDictionary<string,string>();
		...
		var cc_reg_FR = new SortedDictionary<string,string>();
		...
		var cc_reg_GA = new SortedDictionary<string,string>();
		...
		var cc_reg_GB = new SortedDictionary<string,string>();
		...
		var cc_reg_GD = new SortedDictionary<string,string>();
		...
		var cc_reg_GE = new SortedDictionary<string,string>();
		...
		var cc_reg_GH = new SortedDictionary<string,string>();
		...
		var cc_reg_GN = new SortedDictionary<string,string>();
		...
		var cc_reg_GQ = new SortedDictionary<string,string>();
		...
		var cc_reg_GR = new SortedDictionary<string,string>();
		...
		var cc_reg_GT = new SortedDictionary<string,string>();
		...
		var cc_reg_GW = new SortedDictionary<string,string>();
		...
		var cc_reg_GY = new SortedDictionary<string,string>();
		...
		var cc_reg_HN = new SortedDictionary<string,string>();
		...
		var cc_reg_HR = new SortedDictionary<string,string>();
		...
		var cc_reg_HT = new SortedDictionary<string,string>();
		...
		var cc_reg_HU = new SortedDictionary<string,string>();
		...
		var cc_reg_ID = new SortedDictionary<string,string>();
		...
		var cc_reg_IE = new SortedDictionary<string,string>();
		...
		var cc_reg_IL = new SortedDictionary<string,string>();
		...
		var cc_reg_IN = new SortedDictionary<string,string>();
		...
		var cc_reg_IQ = new SortedDictionary<string,string>();
		...
		var cc_reg_IR = new SortedDictionary<string,string>();
		...
		var cc_reg_IS = new SortedDictionary<string,string>();
		...
		var cc_reg_IT = new SortedDictionary<string,string>();
		...
		var cc_reg_JM = new SortedDictionary<string,string>();
		...
		var cc_reg_JO = new SortedDictionary<string,string>();
		...
		var cc_reg_JP = new SortedDictionary<string,string>();
		...
		var cc_reg_KE = new SortedDictionary<string,string>();
		...
		var cc_reg_KG = new SortedDictionary<string,string>();
		...
		var cc_reg_KH = new SortedDictionary<string,string>();
		...
		var cc_reg_KI = new SortedDictionary<string,string>();
		...
		var cc_reg_KP = new SortedDictionary<string,string>();
		...
		var cc_reg_KR = new SortedDictionary<string,string>();
		...
		var cc_reg_KW = new SortedDictionary<string,string>();
		...
		var cc_reg_KY = new SortedDictionary<string,string>();
		...
		var cc_reg_KZ = new SortedDictionary<string,string>();
		...
		var cc_reg_LA = new SortedDictionary<string,string>();
		...
		var cc_reg_LB = new SortedDictionary<string,string>();
		...
		var cc_reg_LC = new SortedDictionary<string,string>();
		...
		var cc_reg_LI = new SortedDictionary<string,string>();
		...
		var cc_reg_LK = new SortedDictionary<string,string>();
		...
		var cc_reg_LR = new SortedDictionary<string,string>();
		...
		var cc_reg_LS = new SortedDictionary<string,string>();
		...
		var cc_reg_LT = new SortedDictionary<string,string>();
		...
		var cc_reg_LY = new SortedDictionary<string,string>();
		...
		var cc_reg_MA = new SortedDictionary<string,string>();
		...
		var cc_reg_MG = new SortedDictionary<string,string>();
		...
		var cc_reg_MK = new SortedDictionary<string,string>();
		...
		var cc_reg_ML = new SortedDictionary<string,string>();
		...
		var cc_reg_MM = new SortedDictionary<string,string>();
		...
		var cc_reg_MN = new SortedDictionary<string,string>();
		...
		var cc_reg_MO = new SortedDictionary<string,string>();
		cc_reg_MO.Add ("01", "Ilhas");
		cc_reg_MO.Add ("02", "Macau");
		GEOIP_REGION_NAME.Add ("MO", cc_reg_MO);
		var cc_reg_MR = new SortedDictionary<string,string>();
		...
		var cc_reg_MS = new SortedDictionary<string,string>();
		...
		var cc_reg_MU = new SortedDictionary<string,string>();
		...
		var cc_reg_MV = new SortedDictionary<string,string>();
		...
		var cc_reg_MW = new SortedDictionary<string,string>();
		...
		var cc_reg_MX = new SortedDictionary<string,string>();
		...
		var cc_reg_MY = new SortedDictionary<string,string>();
		...
		var cc_reg_MZ = new SortedDictionary<string,string>();
		...
		var cc_reg_NA = new SortedDictionary<string,string>();
		...
		var cc_reg_NE = new SortedDictionary<string,string>();
		...
		var cc_reg_NG = new SortedDictionary<string,string>();
		...
		var cc_reg_NI = new SortedDictionary<string,string>();
		...
		var cc_reg_NL = new SortedDictionary<string,string>();
		...
		var cc_reg_NO = new SortedDictionary<string,string>();
		...
		var cc_reg_NP = new SortedDictionary<string,string>();
		...
		var cc_reg_NR = new SortedDictionary<string,string>();
		...
		var cc_reg_NZ = new SortedDictionary<string,string>();
		...
		var cc_reg_OM = new SortedDictionary<string,string>();
		...
		var cc_reg_PA = new SortedDictionary<string,string>();
		...
		var cc_reg_PE = new SortedDictionary<string,string>();
		...
		var cc_reg_PG = new SortedDictionary<string,string>();
		...
		var cc_reg_PH = new SortedDictionary<string,string>();
		...
		var cc_reg_PK = new SortedDictionary<string,string>();
		...
		var cc_reg_PL = new SortedDictionary<string,string>();
		...
		var cc_reg_PS = new SortedDictionary<string,string>();
		cc_reg_PS.Add ("GZ", "Gaza");
		cc_reg_PS.Add ("WE", "West Bank");
		GEOIP_REGION_NAME.Add ("PS", cc_reg_PS);
		var cc_reg_PT = new SortedDictionary<string,string>();
		...
		var cc_reg_PY = new SortedDictionary<string,string>();
		...
		var cc_reg_QA = new SortedDictionary<string,string>();
		...
		var cc_reg_RO = new SortedDictionary<string,string>();
		...
		var cc_reg_RS = new SortedDictionary<string,string>();
		cc_reg_RS.Add ("01", "Kosovo");
		cc_reg_RS.Add ("02", "Vojvodina");
		GEOIP_REGION_NAME.Add ("RS", cc_reg_RS);
		var cc_reg_RU = new SortedDictionary<string,string>();
		...
		var cc_reg_RW = new SortedDictionary<string,string>();
		...
		var cc_reg_SA = new SortedDictionary<string,string>();
		...
		var cc_reg_SB = new SortedDictionary<string,string>();
		...
		var cc_reg_SC = new SortedDictionary<string,string>();
		...
		var cc_reg_SD = new SortedDictionary<string,string>();
		...
		var cc_reg_SE = new SortedDictionary<string,string>();
		...
		var cc_reg_SH = new SortedDictionary<string,string>();
		...
		var cc_reg_SI = new SortedDictionary<string,string>();
		...
		var cc_reg_SK = new SortedDictionary<string,string>();
		...
		var cc_reg_SL = new SortedDictionary<string,string>();
		...
		var cc_reg_SM = new SortedDictionary<string,string>();
		...
		var cc_reg_SN = new SortedDictionary<string,string>();
		...
		var cc_reg_SO = new SortedDictionary<string,string>();
		...
		var cc_reg_SR = new SortedDictionary<string,string>();
		...
		var cc_reg_ST = new SortedDictionary<string,string>();
		cc_reg_ST.Add ("01", "Principe");
		cc_reg_ST.Add ("02", "Sao Tome");
		GEOIP_REGION_NAME.Add ("ST", cc_reg_ST);
		var cc_reg_SV = new SortedDictionary<string,string>();
		...
		var cc_reg_SY = new SortedDictionary<string,string>();
		...
		var cc_reg_SZ = new SortedDictionary<string,string>();
		...
		var cc_reg_TD = new SortedDictionary<string,string>();
		...
		var cc_reg_TG = new SortedDictionary<string,string>();
		...
		var cc_reg_TH = new SortedDictionary<string,string>();
		...
		var cc_reg_TN = new SortedDictionary<string,string>();
		...
		var cc_reg_TO = new SortedDictionary<string,string>();
		cc_reg_TO.Add ("01", "Ha");
		cc_reg_TO.Add ("02", "Tongatapu");
		cc_reg_TO.Add ("03", "Vava");
		GEOIP_REGION_NAME.Add ("TO", cc_reg_TO);
		var cc_reg_TR = new SortedDictionary<string,string>();
		...
		var cc_reg_TT = new SortedDictionary<string,string>();
		...
		var cc_reg_TW = new SortedDictionary<string,string>();
		...
		var cc_reg_TZ = new SortedDictionary<string,string>();
		...
		var cc_reg_UA = new SortedDictionary<string,string>();
		...
		var cc_reg_UG = new SortedDictionary<string,string>();
		...
		var cc_reg_US = new SortedDictionary<string,string>();
		...
		var cc_reg_UY = new SortedDictionary<string,string>();
		...
		var cc_reg_UZ = new SortedDictionary<string,string>();
		...
		var cc_reg_VC = new SortedDictionary<string,string>();
		...
		var cc_reg_VE = new SortedDictionary<string,string>();
		...
		var cc_reg_VN = new SortedDictionary<string,string>();
		...
		var cc_reg_VU = new SortedDictionary<string,string>();
		...
		var cc_reg_WS = new SortedDictionary<string,string>();
		...
		var cc_reg_YE = new SortedDictionary<string,string>();
		...
		var cc_reg_ZA = new SortedDictionary<string,string>();
		...
		var cc_reg_ZM = new SortedDictionary<string,string>();
		...
		var cc_reg_ZW = new SortedDictionary<string,string>();
